...
//add by erlangZhang
/**
 * If set to YES, enables progress size download support.
 *
 * The [SDWebImageDownloaderDelegate imageDownloader:totalSize:receiveSize:] delegate method is then called
 * while the image is downloaded with an image object containing the portion of the currently downloaded
 * image.
 *
 */
@property (nonatomic, readwrite) BOOL progressDisplay;
